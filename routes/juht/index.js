...
exports.get = async (req, res) => {
    ...
    const Document = new Doc(documentType, null, user.userId, user.asutusId, 'juht');
    ...
    const sqlData = {
        ...
        menu: await db.queryDb(menuModel.sqlString, ['juht']),
